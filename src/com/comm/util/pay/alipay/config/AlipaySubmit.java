package com.comm.util.pay.alipay.config;
...
import com.comm.util.pay.alipay.sign.MD5;
import com.comm.util.pay.alipay.sign.RSA;
import com.comm.util.pay.alipay.util.direct.AlipayCore;
...
public class AlipaySubmit {
    ...
    private static Map<String, String> buildRequestPara(Map<String, String> sParaTemp) {
        ...
        if(! sPara.get("service").equals("alipay.wap.trade.create.direct") && ! sPara.get("service").equals("alipay.wap.auth.authAndExecute")) {
        	sPara.put("sign_type", AlipayConfig.wap_sign_type);
        }
