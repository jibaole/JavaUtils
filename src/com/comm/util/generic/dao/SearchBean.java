 ...
 * {@link SearchBean#getDoIndexFields}和 {@link SearchBean#initPublicFields()}
 * 
 * 三个方法<br/>
 * 
 * eg:<br/>
...
public abstract class SearchBean {
	...
	private String getValue(String field, Object obj) {
		...
		try {
			Object value = null;// ObjectUtils.getFieldValue(object, field);
			if (value == null)
			...
			logger.error(
					"can not find a value for field '{}' in object class '{}'!",
	...
	/**
	 * you must use this method when you create the index, set what object you
	 * will to be created its index!
	 * 
	 * @param object
	 *            the object which you will want to be create index
	 */
