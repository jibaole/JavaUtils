...
public class PinYin2Abbreviation {  
    ...
    public static String cn2py(String SourceStr) {  
        String Result = "";  
        SourceStr=filterChar(SourceStr);
    ...
    public static String cn2fpy(String SourceStr) {  
        String Result = ""; 
        SourceStr=filterChar(SourceStr);
        int StrLength = SourceStr.length();  
        int i;  
        try {  
            for (i = 0; i < StrLength; i=StrLength) {  
                Result += Char2Initial(SourceStr.charAt(i));  
            }  
    ...
    private static String filterChar(String SourceStr){
    	 SourceStr=SourceStr.replaceAll("髋","宽");
    	 return SourceStr;
    }
    /** 
     * 取出汉字的编码 cn 汉字 　　 
