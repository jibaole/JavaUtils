...
public class Des {
    ...
    public String strDec(String data, String firstKey, String secondKey,
            String thirdKey) {
    	//data="4A23DAD7F4BB8269EEB9A471F8E39A62";
        int leng = data.length();
        String decStr = "";
        List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
        int firstLength = 0, secondLength = 0, thirdLength = 0;
    ...
    public static void main(String[] args) {
        ...
        String key2 = "2";
        String key3 = "3";
        String data = "张三-BJ010059";
        String str = desObj.strEnc(data, key1, key2, key3);
        System.out.println(str);
        String dec = desObj.strDec("8D7E57BBA32FCA6694E05F6D4F338975B199A72A8B4D6108", key1, key2, key3);
